...
export const errors = {
  FILE_TOO_LARGE: {
    message:
      "फ़ाइल बहुत बड़ी है। कृपया एक छोटी फ़ाइल चुनें या हमारे compress-pdf उपकरण का उपयोग करके फ़ाइल का आकार कम करें।",
    code: "ERR_FILE_SIZE_LIMIT_EXCEEDED",
  },
  NOT_SUPPORTED_TYPE: {
    message: "फ़ाइल समर्थित प्रकार नहीं है।",
    types: {
      PDF: "कृपया एक मान्य पीडीएफ फ़ाइल चुनें।",
      JPG: "कृपया एक मान्य JPEG छवि फ़ाइल चुनें।",
      ...
      PPT: "कृपया एक मान्य पावरपॉइंट प्रस्तुति फ़ाइल चुनें।",
  ...
  FILE_CORRUPT: {
    message:
      "फ़ाइल अप्रचलित है और प्रसंस्कृत नहीं की जा सकती है। कृपया एक मान्य फ़ाइल चुनें।",
    code: "ERR_FILE_CORRUPT",
  },
  MISSING_FONTS: {
    message:
      "फ़ाइल अनुपलब्ध फ़ोंट्स शामिल करती है। कृपया सुनिश्चित करें कि सभी फ़ोंट पीडीएफ फ़ाइल में सम्मिलित हैं।",
    code: "ERR_MISSING_FONTS",
  },
  INVALID_IMAGE_DATA: {
    message:
      "फ़ाइल में अमान्य छवि डेटा होता है। कृपया सुनिश्चित करें कि सभी छवियाँ ठीक ढंग से फ़ॉर्मेट की गई हैं।",
    code: "ERR_INVALID_IMAGE_DATA",
  },
  SECURITY_RISK: {
    message:
      "फ़ाइल में सुरक्षा जोखिम होता है जिसे प्रसंस्कृत नहीं किया जा सकता है। कृपया एक मान्य फ़ाइल चुनें।",
