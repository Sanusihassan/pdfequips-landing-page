...
export const errors = {
  FILE_TOO_LARGE: {
    message:
      "El archivo es demasiado grande. Por favor, elige un archivo más pequeño o utiliza nuestra herramienta compress-pdf para reducir el tamaño del archivo.",
    code: "ERR_FILE_SIZE_LIMIT_EXCEEDED",
  },
  NOT_SUPPORTED_TYPE: {
    message: "El archivo no es de un tipo compatible.",
    types: {
      PDF: "Por favor, elige un archivo PDF válido.",
      JPG: "Por favor, elige un archivo de imagen JPEG válido.",
      DOC: "Por favor, elige un archivo de documento Word válido.",
      DOCX: "Por favor, elige un archivo de documento Word válido.",
      XLS: "Por favor, elige un archivo de hoja de cálculo Excel válido.",
      XLSX: "Por favor, elige un archivo de hoja de cálculo Excel válido.",
      PPT: "Por favor, elige un archivo de presentación PowerPoint válido.",
      PPTX: "Por favor, elige un archivo de presentación PowerPoint válido.",
    },
  ...
  MISSING_FONTS: {
    message:
      "El archivo contiene fuentes faltantes. Por favor, asegúrate de que todas las fuentes estén incrustadas en el archivo PDF.",
    code: "ERR_MISSING_FONTS",
  },
  INVALID_IMAGE_DATA: {
    message:
      "El archivo contiene datos de imagen no válidos. Por favor, asegúrate de que todas las imágenes estén correctamente formateadas.",
  ...
  UNKNOWN_ERROR: {
    message:
      "Ocurrió un error desconocido. Por favor, inténtalo de nuevo más tarde o ponte en contacto con el soporte.",
    code: "ERR_UNKNOWN",
  },
};
