...
type FileProps = {
    store: ToolState, errors: _, extension: string, imageUrls: {
        file: File;
        imageUrl: string;
    }[], setImageUrls: Dispatch<SetStateAction<{
        file: File;
        imageUrl: string;
    }[]>>, toolTipSizes: string[], setToolTipSizes: Dispatch<SetStateAction<string[]>>
}
const Files = ({ store, errors, extension, imageUrls, setImageUrls, toolTipSizes, setToolTipSizes }: FileProps) => {
